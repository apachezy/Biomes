...
public class EditBiomeGUI extends CommonGUI
{
    ...
    private static final String ENVIRONMENT_ACTIVE = "biomes.gui.descriptions.admin.environment-active";
    private static final String ENVIRONMENT_INACTIVE = "biomes.gui.descriptions.admin.environment-inactive";
    ...
    private PanelItem createButton(Button button)
    {
        ...
        case ENVIRONMENT:
            ...
            {
            case NORMAL:
                description.add(this.user.getTranslation(ENVIRONMENT_ACTIVE, VALUE, NORMAL));
                description.add(this.user.getTranslation(ENVIRONMENT_INACTIVE, VALUE, NETHER));
                description.add(this.user.getTranslation(ENVIRONMENT_INACTIVE, VALUE, THE_END));

                itemBuilder.icon(Material.GRASS_BLOCK);
                break;
            case NETHER:
                description.add(this.user.getTranslation(ENVIRONMENT_INACTIVE, VALUE, NORMAL));
                description.add(this.user.getTranslation(ENVIRONMENT_ACTIVE, VALUE, NETHER));
                description.add(this.user.getTranslation(ENVIRONMENT_INACTIVE, VALUE, THE_END));
            ...
            case THE_END:
                description.add(this.user.getTranslation(ENVIRONMENT_INACTIVE, VALUE, NORMAL));
                description.add(this.user.getTranslation(ENVIRONMENT_INACTIVE, VALUE, NETHER));
                description.add(this.user.getTranslation(ENVIRONMENT_ACTIVE, VALUE, THE_END));
