...
public class SelectBlocksGUI
{
    ...
    public SelectBlocksGUI(User user, boolean singleItem, BiConsumer<Boolean, Set<Material>> consumer)
    {
        this(user, singleItem, new HashSet<>(), consumer);
    }


    @SuppressWarnings("deprecation")
    public SelectBlocksGUI(User user, boolean singleItem, Set<Material> excludedMaterial, BiConsumer<Boolean, Set<Material>> consumer)
    {
    ...
    public void build(int pageIndex)
    {
        PanelBuilder panelBuilder = new PanelBuilder().user(this.user).
                name(this.user.getTranslation("biomes.gui.title.admin.select-block"));
        ...
        panelBuilder.item(3,
                ...
                name(this.user.getTranslation("biomes.gui.buttons.admin.cancel")).
        ...
        panelBuilder.item(5,
                ...
                name(this.user.getTranslation("biomes.gui.buttons.admin.accept")).
    ...
    private PanelItem createMaterialButton(Material material)
    {
        ...
        return new PanelItemBuilder().
                ...
                icon(itemStack).
                clickHandler((panel, user1, clickType, slot) -> {
                    if (!this.singleItem && clickType.isRightClick())
                    {
    ...
    /**
     * Boolean that indicate if user can select multiple or single item.
     */
